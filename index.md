...
Computational Beha**Vi**or and Heal**T**h **A**na**L**ytics (**ViTAL**) Lab strives to develop **Patient-oriented Artificial Intelligence (AI) systems** that are *Inclusive*, *Accessible*, and *Ethical* to effectively improve the healthcare system. 
